...
import NestIcon from "../Icons/brands/NestIcon"
import GoIcon from "../Icons/brands/GoIcon"
    ...
    >
      <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
        ...
        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          ...
          Mongo, Go and many more... My main stack is:
        </p>
      </div>
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        ...
        <div className="relative overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            <NestIcon className=" h-auto w-14 fill-current" />
            <div className="space-y-2">
              <h3 className="font-bold">Nest.js</h3>
              <p className="text-sm text-muted-foreground">
                Modular architecture, dependency injection, and support for
                GraphQL, REST APIs, and microservices.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-20  overflow-hidden rounded-lg border bg-background p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            <GoIcon className="h-12 w-12 fill-current" />
            <div className="space-y-2">
              <h3 className="font-bold">Go</h3>
              <p className="text-sm text-muted-foreground">
                High-performance backend development, lightweight concurrency.
              </p>
            </div>
          </div>
        </div>
